...
export class TriadicMixer extends ColorMixer {
  private readonly ANGLE_RANGE = 10;
  private readonly ANGLE_DISTANCE = 120;
  ...
  generateColors(): Color[] {
    ...
    const RIGHT_COLOR_MIN = baseColorHSL.hue + (this.ANGLE_DISTANCE * 2 + this.ANGLE_RANGE / 2);
